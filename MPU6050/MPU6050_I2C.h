...
#define MPU6050_IIC_SCL_Pin                GPIO_Pin_6      	 //PB10
#define MPU6050_IIC_SDA_Pin                GPIO_Pin_7	         //PB11

#define	MPU6050_IIC_SCL                    PBout(6)
#define	MPU6050_IIC_SDA                    PBout(7)  
#define	MPU6050_IIC_SDA_IN                 PBin(7)              //读数据端口
